...
package projetsid.dumpproduct_0_1;
...
/**
 * Job: dumpProduct Purpose: load le product<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class dumpProduct implements TalendJob {
	...
	private final String jobName = "dumpProduct";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dumpProduct.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:gUHBm5NUiE2qYdEqjRbiHKB6zghofEwu6DbPNBEoOiXeGnSdn6R3aQYrW1JuW9MZhgzaIKv/G9inY/zt");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_dumpProduct = new byte[0];
		static byte[] commonByteArray_PROJETSID_dumpProduct = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_dumpProduct.length) {
					if (length < 1024 && commonByteArray_PROJETSID_dumpProduct.length == 0) {
						commonByteArray_PROJETSID_dumpProduct = new byte[1024];
					} else {
						commonByteArray_PROJETSID_dumpProduct = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_dumpProduct, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpProduct, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_dumpProduct, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpProduct, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_dumpProduct) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Product")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"product_Id\" VARCHAR(12)   not null ,\"product_Name\" VARCHAR(50)   not null ,\"product_Ref_Id\" VARCHAR(12)  ,primary key(\"product_Id\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"product_Id\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"product_Id\",\"product_Name\",\"product_Ref_Id\") VALUES (?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"product_Name\" = ?,\"product_Ref_Id\" = ? WHERE \"product_Id\" = ?";
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.folderName + "/files/TablesToDump/Product.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/TablesToDump/Product.csv", "ISO-8859-15", ";", "\n", true,
...
///////////////////////		
							...
							if (row1.Product_Name != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Product_Name));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.Product_Ref_ID != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.Product_Ref_ID));
...
///////////////////////    			
							...
							if (row2.Product_ID == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.Product_ID);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.Product_Name == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, row2.Product_Name);
								}

								if (row2.Product_Ref_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, row2.Product_Ref_ID);
								}

								if (row2.Product_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.Product_ID);
								}
								...
								if (row2.Product_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, row2.Product_ID);
								}

								if (row2.Product_Name == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, row2.Product_Name);
								}

								if (row2.Product_Ref_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, row2.Product_Ref_ID);
								}
					...
					if (!((Object) (context.folderName
							+ "/files/TablesToDump/Product.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dumpProduct dumpProductClass = new dumpProduct();

		int exitCode = dumpProductClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpProduct.class.getClassLoader()
					.getResourceAsStream("projetsid/dumpproduct_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpProduct.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpProduct");
		}
...
/************************************************************************************************
 * 76147 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2024 à 16:26:54 CEST
 ************************************************************************************************/