 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_1";
		...
		int tos_count_tDBConnection_1 = 0;
            ...
            String url_tDBConnection_1 = "jdbc:postgresql://"+"postgresql-casiop-sid-24-ajj.alwaysdata.net"+":"+"5432"+"/"+"casiop-sid-24-ajj_bdd";
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:j48pIC6LzkNfubDHKJIGy3Luf8CE2cUAO8vB/IfLEp1fFb50pZcEM6n62DKkrxqr8ebaxMYwVxl3X4d5");
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("Order_Line"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"Order_ID\" VARCHAR(20)  ,\"Order_Item_Num\" INT4 ,\"Total_Retail_Price\" FLOAT4 ,\"CostPrice_Per_Unit\" FLOAT4 ,\"Quantity\" INT4 ,\"Product_ID\" VARCHAR(20)  ,primary key(\"Order_ID\",\"Order_Item_Num\"))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"Order_ID\" = ? AND \"Order_Item_Num\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"Order_ID\",\"Order_Item_Num\",\"Total_Retail_Price\",\"CostPrice_Per_Unit\",\"Quantity\",\"Product_ID\") VALUES (?,?,?,?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"Total_Retail_Price\" = ?,\"CostPrice_Per_Unit\" = ?,\"Quantity\" = ?,\"Product_ID\" = ? WHERE \"Order_ID\" = ? AND \"Order_Item_Num\" = ?";
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.folderName+"/files/TablesToDump/OrderLine.csv", "UTF-8",";","\n",true,1,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Order_Item_Num", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"Total_Retail_Price", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
										"CostPrice_Per_Unit", "row1", temp, ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
								}
...
} else {pstmt_tDBOutput_1.setString(1, row2.Order_ID);
}

                    if(row2.Order_Item_Num == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, row2.Order_Item_Num);
}
...
} else {pstmtUpdate_tDBOutput_1.setFloat(1, row2.Total_Retail_Price);
}

                        if(row2.CostPrice_Per_Unit == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.FLOAT);
} else {pstmtUpdate_tDBOutput_1.setFloat(2, row2.CostPrice_Per_Unit);
}

                        if(row2.Quantity == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(3, row2.Quantity);
}

                        if(row2.Product_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, row2.Product_ID);
}

                        if(row2.Order_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, row2.Order_ID);
}

                        if(row2.Order_Item_Num == null) {
pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(6 + count_tDBOutput_1, row2.Order_Item_Num);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.Order_ID);
}

                        if(row2.Order_Item_Num == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(2, row2.Order_Item_Num);
}

                        if(row2.Total_Retail_Price == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_1.setFloat(3, row2.Total_Retail_Price);
}

                        if(row2.CostPrice_Per_Unit == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.FLOAT);
} else {pstmtInsert_tDBOutput_1.setFloat(4, row2.CostPrice_Per_Unit);
}

                        if(row2.Quantity == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(5, row2.Quantity);
}

                        if(row2.Product_ID == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, row2.Product_ID);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.folderName+"/files/TablesToDump/OrderLine.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dumpOrderLine.class.getClassLoader().getResourceAsStream("projetsid/dumporderline_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dumpOrderLine.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpOrderLine");
        }
...
/************************************************************************************************
 *     87754 characters generated by Talend Open Studio for Data Integration 
 *     on the 9 mai 2024 à 19:10:24 CEST
 ************************************************************************************************/