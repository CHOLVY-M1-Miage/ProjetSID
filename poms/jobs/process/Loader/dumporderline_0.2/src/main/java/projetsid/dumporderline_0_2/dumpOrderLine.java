		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:3ULBxr4ykqBkbzbplUolbvxscvZZwM4lf3bN82zzFA+RI5s8E5k9FHOT/nuhaA3khOrZwTYjkF3VVNj2");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"Order_ID\" VARCHAR(20)  ,\"Order_Item_Num\" INT4 ,\"Total_Retail_Price\" FLOAT4 ,\"CostPrice_Per_Unit\" FLOAT4 ,\"Quantity\" INT4 ,\"Product_ID\" VARCHAR(20)  ,primary key(\"Order_ID\",\"Order_Item_Num\"))");
					}
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"Order_ID\",\"Order_Item_Num\",\"Total_Retail_Price\",\"CostPrice_Per_Unit\",\"Quantity\",\"Product_ID\") VALUES (?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"Total_Retail_Price\" = ?,\"CostPrice_Per_Unit\" = ?,\"Quantity\" = ?,\"Product_ID\" = ? WHERE \"Order_ID\" = ? AND \"Order_Item_Num\" = ?";
...
///////////////////////		
							...
							if (row1.Order_ID != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Order_ID));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.Order_Item_Num != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.Order_Item_Num));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.Total_Retail_Price != null) { //

								strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(row1.Total_Retail_Price));
							...
							if (row1.CostPrice_Per_Unit != null) { //
								...
								strBuffer_tLogRow_1.append(FormatterUtils.formatUnwithE(row1.CostPrice_Per_Unit));
							...
							if (row1.Quantity != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Quantity));
							...
							if (row1.Product_ID != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Product_ID));
...
///////////////////////    			
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.Total_Retail_Price == null) {
									...
									pstmtUpdate_tDBOutput_1.setFloat(1, row2.Total_Retail_Price);
								}

								if (row2.CostPrice_Per_Unit == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.FLOAT);
								} else {
									pstmtUpdate_tDBOutput_1.setFloat(2, row2.CostPrice_Per_Unit);
								}

								if (row2.Quantity == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
								} else {
									pstmtUpdate_tDBOutput_1.setInt(3, row2.Quantity);
								}

								if (row2.Product_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4, row2.Product_ID);
								}

								if (row2.Order_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, row2.Order_ID);
								}

								if (row2.Order_Item_Num == null) {
									pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.INTEGER);
								} else {
									pstmtUpdate_tDBOutput_1.setInt(6 + count_tDBOutput_1, row2.Order_Item_Num);
								}
								...
								if (row2.Total_Retail_Price == null) {
									...
									pstmtInsert_tDBOutput_1.setFloat(3, row2.Total_Retail_Price);
								}

								if (row2.CostPrice_Per_Unit == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(4, row2.CostPrice_Per_Unit);
								}

								if (row2.Quantity == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(5, row2.Quantity);
								}

								if (row2.Product_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(6, row2.Product_ID);
								}
...
/************************************************************************************************
 * 90539 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 18:41:30 CEST
 ************************************************************************************************/