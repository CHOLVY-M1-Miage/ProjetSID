...
package projetsid.dumporderline_0_2;
...
public class dumpOrderLine implements TalendJob {
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:postgresql://" + "postgresql-casiop-sid-24-ajj.alwaysdata.net" + ":"
						+ "5432" + "/" + "casiop-sid-24-ajj_bdd";
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ho+I/mFm9LwRzDXp8gA43kSCZapBMHEWlk5uDor1shR92HOEfyLb2klcI6cxl4PN9/xzbla2PvQFQC5o");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_dumpOrderLine = new byte[0];
		static byte[] commonByteArray_PROJETSID_dumpOrderLine = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_dumpOrderLine.length) {
					if (length < 1024 && commonByteArray_PROJETSID_dumpOrderLine.length == 0) {
						commonByteArray_PROJETSID_dumpOrderLine = new byte[1024];
					} else {
						commonByteArray_PROJETSID_dumpOrderLine = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_dumpOrderLine, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpOrderLine, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_dumpOrderLine, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpOrderLine, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_dumpOrderLine) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Order_Line");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Order_Line");
				}
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Order_Line")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"Order_ID\" = ? AND \"Order_Item_Num\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"Order_ID\",\"Order_Item_Num\",\"Product_ID\",\"Quantity\",\"Product_Price_Per_Unit\",\"Total_Retail_Price\",\"CostPrice_Per_Unit\",\"Marge_Per_Unit\",\"Order_Type\",\"Order_Date\",\"Delivery_Date\",\"Country\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"Product_ID\" = ?,\"Quantity\" = ?,\"Product_Price_Per_Unit\" = ?,\"Total_Retail_Price\" = ?,\"CostPrice_Per_Unit\" = ?,\"Marge_Per_Unit\" = ?,\"Order_Type\" = ?,\"Order_Date\" = ?,\"Delivery_Date\" = ?,\"Country\" = ? WHERE \"Order_ID\" = ? AND \"Order_Item_Num\" = ?";
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.folderName + "/files/TablesToDump/OrderLine.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/TablesToDump/OrderLine.csv", "UTF-8", ";", "\n", true, 1,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"Order_Item_Num", "row1", temp, ex_tFileInputDelimited_1),
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Product_Price_Per_Unit", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Total_Retail_Price", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"CostPrice_Per_Unit", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Marge_Per_Unit", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Order_Date", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Delivery_Date", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row2.Order_Item_Num == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(2, row2.Order_Item_Num);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								...
								if (row2.Delivery_Date != null) {
									pstmtUpdate_tDBOutput_1.setTimestamp(9,
											new java.sql.Timestamp(row2.Delivery_Date.getTime()));
								} else {
								...
								if (row2.Country == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(10, row2.Country);
								}

								if (row2.Order_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(11 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(11 + count_tDBOutput_1, row2.Order_ID);
								}

								if (row2.Order_Item_Num == null) {
									pstmtUpdate_tDBOutput_1.setNull(12 + count_tDBOutput_1, java.sql.Types.INTEGER);
								} else {
									pstmtUpdate_tDBOutput_1.setInt(12 + count_tDBOutput_1, row2.Order_Item_Num);
								}
								...
								if (row2.Order_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, row2.Order_ID);
								}

								if (row2.Order_Item_Num == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(2, row2.Order_Item_Num);
								}

								if (row2.Product_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, row2.Product_ID);
								}

								if (row2.Quantity == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(4, row2.Quantity);
								}

								if (row2.Product_Price_Per_Unit == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(5, row2.Product_Price_Per_Unit);
								}

								if (row2.Total_Retail_Price == null) {
									pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(6, row2.Total_Retail_Price);
								}

								if (row2.CostPrice_Per_Unit == null) {
									pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(7, row2.CostPrice_Per_Unit);
								}

								if (row2.Marge_Per_Unit == null) {
									pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.FLOAT);
								} else {
									pstmtInsert_tDBOutput_1.setFloat(8, row2.Marge_Per_Unit);
								}

								if (row2.Order_Type == null) {
									pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(9, row2.Order_Type);
								}
								...
								if (row2.Country == null) {
									...
									pstmtInsert_tDBOutput_1.setString(12, row2.Country);
								}
					...
					if (!((Object) (context.folderName
							+ "/files/TablesToDump/OrderLine.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpOrderLine.class.getClassLoader()
					.getResourceAsStream("projetsid/dumporderline_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 104972 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2024 à 14:39:25 CEST
 ************************************************************************************************/