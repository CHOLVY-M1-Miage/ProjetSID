...
package projetsid.dumpcustomertype_0_2;
...
/**
 * Job: dumpCustomerType Purpose: load le product<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class dumpCustomerType implements TalendJob {
	...
	private final String jobName = "dumpCustomerType";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					dumpCustomerType.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dumpCustomerType.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:PY5uvZNe2D35oP/8ADuKCPKpuwkQQPdYv5McjXN3KbF8NMDVqvOJOI32XPXB6C+rXhWYN4o0+5mCtwH6");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_dumpCustomerType = new byte[0];
		static byte[] commonByteArray_PROJETSID_dumpCustomerType = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_dumpCustomerType.length) {
					if (length < 1024 && commonByteArray_PROJETSID_dumpCustomerType.length == 0) {
						commonByteArray_PROJETSID_dumpCustomerType = new byte[1024];
					} else {
						commonByteArray_PROJETSID_dumpCustomerType = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_dumpCustomerType, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpCustomerType, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_dumpCustomerType, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpCustomerType, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_dumpCustomerType) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Customer_Type");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Customer_Type");
				}
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Customer_Type"))
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"customer_Type_Id\" VARCHAR(4)   not null ,\"customer_Type_Name\" VARCHAR(50)   not null ,\"customer_Group_Ref_Id\" VARCHAR(2)  ,primary key(\"customer_Type_Id\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"customer_Type_Id\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"customer_Type_Id\",\"customer_Type_Name\",\"customer_Group_Ref_Id\") VALUES (?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"customer_Type_Name\" = ?,\"customer_Group_Ref_Id\" = ? WHERE \"customer_Type_Id\" = ?";
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.folderName
							+ "/files/TablesToDump/Customer_Type.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/TablesToDump/Customer_Type.csv", "UTF-8", ";", "\n", true,
...
///////////////////////		
							...
							if (row1.Customer_Type_ID != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.Customer_Type_ID));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.Customer_Type != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.Customer_Type));

							} //

							strBuffer_tLogRow_1.append("|");

							if (row1.Customer_Group_ID != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.Customer_Group_ID));
...
///////////////////////    			
							...
							if (row2.Customer_Type_ID == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.Customer_Type_ID);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.Customer_Type == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, row2.Customer_Type);
								}

								if (row2.Customer_Group_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, row2.Customer_Group_ID);
								}

								if (row2.Customer_Type_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.Customer_Type_ID);
								}
								...
								if (row2.Customer_Type_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, row2.Customer_Type_ID);
								}

								if (row2.Customer_Type == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, row2.Customer_Type);
								}

								if (row2.Customer_Group_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, row2.Customer_Group_ID);
								}
					...
					if (!((Object) (context.folderName
							+ "/files/TablesToDump/Customer_Type.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dumpCustomerType dumpCustomerTypeClass = new dumpCustomerType();

		int exitCode = dumpCustomerTypeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpCustomerType.class.getClassLoader()
					.getResourceAsStream("projetsid/dumpcustomertype_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpCustomerType.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpCustomerType");
		}
...
/************************************************************************************************
 * 76897 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 17:14:19 CEST
 ************************************************************************************************/