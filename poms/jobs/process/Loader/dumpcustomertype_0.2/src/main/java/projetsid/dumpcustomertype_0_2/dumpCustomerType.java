		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:QLVlusPCJbwvoTGkom0i/DxyO77N5JCl0GE2U6QKMWoyccL21GX8/EuEe4NPc7O0kvcwVNFyQ9JQXsMx");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("CustomerType");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("CustomerType");
				}
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("CustomerType"))
...
/************************************************************************************************
 * 76893 characters generated by Talend Open Studio for Data Integration on the
 * 7 mai 2024 à 13:36:22 CEST
 ************************************************************************************************/