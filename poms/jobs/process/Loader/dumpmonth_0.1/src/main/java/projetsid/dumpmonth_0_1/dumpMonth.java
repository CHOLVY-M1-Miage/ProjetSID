...
package projetsid.dumpmonth_0_1;
...
/**
 * Job: dumpMonth Purpose: load le product<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class dumpMonth implements TalendJob {
	...
	private final String jobName = "dumpMonth";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dumpMonth.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:XQBZ20JPVTQAGVL+ip1VhfWvKNu5QQDxHc09jTU6CL6qWHlQ3W+jwiv/4LghUr9cZHn1q64j0DjJy1Jw");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_dumpMonth = new byte[0];
		static byte[] commonByteArray_PROJETSID_dumpMonth = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_dumpMonth.length) {
					if (length < 1024 && commonByteArray_PROJETSID_dumpMonth.length == 0) {
						commonByteArray_PROJETSID_dumpMonth = new byte[1024];
					} else {
						commonByteArray_PROJETSID_dumpMonth = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_dumpMonth, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpMonth, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_dumpMonth, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpMonth, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_dumpMonth) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("Time_Month");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Time_Month");
				}
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Time_Month")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"id\" VARCHAR(7)   not null ,\"monthNb\" INT4  not null ,\"monthName\" VARCHAR(12)   not null ,\"quarterId\" VARCHAR(7)   not null ,primary key(\"id\"))");
					}
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"id\",\"monthNb\",\"monthName\",\"quarterId\") VALUES (?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"monthNb\" = ?,\"monthName\" = ?,\"quarterId\" = ? WHERE \"id\" = ?";
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.folderName + "/files/TablesToDump/Month.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/TablesToDump/Month.csv", "ISO-8859-15", ";", "\n", true, 1,
						...
						try {
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.monthNb = ParserUtils.parseTo_int(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"monthNb", "row1", temp, ex_tFileInputDelimited_1),
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'monthNb' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
							...
							row1.quarterId = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
///////////////////////		
							...
							strBuffer_tLogRow_1.append(String.valueOf(row1.monthNb));

							strBuffer_tLogRow_1.append("|");

							if (row1.monthName != null) { //

								strBuffer_tLogRow_1.append(String.valueOf(row1.monthName));
							...
							if (row1.quarterId != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.quarterId));
...
///////////////////////    			
							...
							if (checkCount_tDBOutput_1 > 0) {
								pstmtUpdate_tDBOutput_1.setInt(1, row2.monthNb);

								if (row2.monthName == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, row2.monthName);
								}

								if (row2.quarterId == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3, row2.quarterId);
								}
								...
								pstmtInsert_tDBOutput_1.setInt(2, row2.monthNb);

								if (row2.monthName == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, row2.monthName);
								}

								if (row2.quarterId == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(4, row2.quarterId);
								}
					...
					if (!((Object) (context.folderName
							+ "/files/TablesToDump/Month.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dumpMonth dumpMonthClass = new dumpMonth();

		int exitCode = dumpMonthClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpMonth.class.getClassLoader()
					.getResourceAsStream("projetsid/dumpmonth_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpMonth.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpMonth");
		}
...
/************************************************************************************************
 * 77617 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 17:38:44 CEST
 ************************************************************************************************/