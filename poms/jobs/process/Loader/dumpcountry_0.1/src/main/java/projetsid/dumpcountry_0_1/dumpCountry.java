...
package projetsid.dumpcountry_0_1;
...
/**
 * Job: dumpCountry Purpose: Charger les donnèes dans la table pays.<br>
 * Description: Remplir la table pays grâces au fichiers csv prédament créer. <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class dumpCountry implements TalendJob {
...
public String getFolderName(){
	...
	private final String jobName = "dumpCountry";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dumpCountry.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:rWji/1Nj++1CKOY7uY3zl/QTmW4/98EVABUtxrx+KB4ez5T474yUAy/a2PlFi7YWxw/zh7bkWeYmRrBl");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJETSID_dumpCountry = new byte[0];
    static byte[] commonByteArray_PROJETSID_dumpCountry = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETSID_dumpCountry.length) {
				if(length < 1024 && commonByteArray_PROJETSID_dumpCountry.length == 0) {
   					commonByteArray_PROJETSID_dumpCountry = new byte[1024];
				} else {
   					commonByteArray_PROJETSID_dumpCountry = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETSID_dumpCountry, 0, length);
			strReturn = new String(commonByteArray_PROJETSID_dumpCountry, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJETSID_dumpCountry, 0, length);
			strReturn = new String(commonByteArray_PROJETSID_dumpCountry, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETSID_dumpCountry) {
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	tableName_tDBOutput_1 = ("Country");
} else {
	tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("Country");
}
...
int count_tDBOutput_1=0;
                                ...
                                try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null, new String[]{"TABLE"})) {
                                    ...
                                    while(rsTable_tDBOutput_1.next()) {
                                        ...
                                        if(table_tDBOutput_1.equals(("Country"))
                                ...
                                if(!whetherExist_tDBOutput_1) {
                                    try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
                                        stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1 + "\"(\"country\" VARCHAR(50)  ,\"country_Name\" VARCHAR(50)  ,\"country_Id\" VARCHAR(50)  ,primary key(\"country\"))");
                                    }
                                }
	    java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"country\" = ?");
	    resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"country\",\"country_Name\",\"country_Id\") VALUES (?,?,?)";
	    java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
	    resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"country_Name\" = ?,\"country_Id\" = ? WHERE \"country\" = ?";
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = context.folderName+"/files/TablesToDump/Contry.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(context.folderName+"/files/TablesToDump/Contry.csv", "ISO-8859-15",";","\n",true,1,0,
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row1.Country_Name)							
				);
...
} else {pstmt_tDBOutput_1.setString(1, row2.Country);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(1, row2.Country_Name);
}

                        if(row2.Country_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, row2.Country_ID);
}

                        if(row2.Country == null) {
pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.Country);
}
...
} else {pstmtInsert_tDBOutput_1.setString(1, row2.Country);
}

                        if(row2.Country_Name == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, row2.Country_Name);
}

                        if(row2.Country_ID == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, row2.Country_ID);
}
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(context.folderName+"/files/TablesToDump/Contry.csv") instanceof java.io.InputStream)){
 ...
 */
    ...
    public static void main(String[] args){
        final dumpCountry dumpCountryClass = new dumpCountry();

        int exitCode = dumpCountryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dumpCountry.class.getClassLoader().getResourceAsStream("projetsid/dumpcountry_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dumpCountry.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpCountry");
        }
...
/************************************************************************************************
 *     75915 characters generated by Talend Open Studio for Data Integration 
 *     on the 9 mai 2024 à 18:44:30 CEST
 ************************************************************************************************/