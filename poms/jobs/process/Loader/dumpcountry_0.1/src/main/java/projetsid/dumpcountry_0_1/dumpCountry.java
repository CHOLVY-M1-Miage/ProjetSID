		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jtazfq0/G1isEfBWXTHOY4YdLFn19HekDIvRAhZJhoMiU93/yoHLWiWYKOfw92h6fvQVfd2dPLQQutKW");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"country\" VARCHAR(50)  ,\"country_Name\" VARCHAR(50)  ,primary key(\"country\"))");
					}
				}
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"country_Name\" = ? WHERE \"country\" = ?";
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (checkCount_tDBOutput_1 > 0) {
								...
								if (row2.Country == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(2 + count_tDBOutput_1, row2.Country);
								}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpCountry.class.getClassLoader()
					.getResourceAsStream("projetsid/dumpcountry_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpCountry.class.getClassLoader()
...
/************************************************************************************************
 * 72538 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 19:41:09 CEST
 ************************************************************************************************/