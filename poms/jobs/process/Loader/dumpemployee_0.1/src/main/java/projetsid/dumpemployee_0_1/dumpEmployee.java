...
package projetsid.dumpemployee_0_1;
...
/**
 * Job: dumpEmployee Purpose: load le product<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class dumpEmployee implements TalendJob {
	...
	private final String jobName = "dumpEmployee";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dumpEmployee.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:0huJHNGomNBwUjoc2PHBdd6bDT4WykDr2+mddp8AlEGeCwgbNC1yKJXXWyOaHH6FMAAncaKDzXPjDKlv");
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_dumpEmployee = new byte[0];
		static byte[] commonByteArray_PROJETSID_dumpEmployee = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_dumpEmployee.length) {
					if (length < 1024 && commonByteArray_PROJETSID_dumpEmployee.length == 0) {
						commonByteArray_PROJETSID_dumpEmployee = new byte[1024];
					} else {
						commonByteArray_PROJETSID_dumpEmployee = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_dumpEmployee, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpEmployee, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_dumpEmployee, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_dumpEmployee, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_dumpEmployee) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Employee")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"Employee_ID\" VARCHAR(30)  ,\"Employee_Job_Title\" VARCHAR(30)  ,\"Employee_Salary\" INT4 ,\"Employee_Gender\" VARCHAR(30)  ,\"Employee_Country\" VARCHAR(30)  ,primary key(\"Employee_ID\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"Employee_ID\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"Employee_ID\",\"Employee_Job_Title\",\"Employee_Salary\",\"Employee_Gender\",\"Employee_Country\") VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"Employee_Job_Title\" = ?,\"Employee_Salary\" = ?,\"Employee_Gender\" = ?,\"Employee_Country\" = ? WHERE \"Employee_ID\" = ?";
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.folderName + "/files/TablesToDump/Employee.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/TablesToDump/Employee.csv", "ISO-8859-15", ";", "\n", true,
...
///////////////////////    			
							...
							if (row2.Employee_ID == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.Employee_ID);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.Employee_Job_Title == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, row2.Employee_Job_Title);
								}

								if (row2.Employee_Salary == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
								} else {
									pstmtUpdate_tDBOutput_1.setInt(2, row2.Employee_Salary);
								}

								if (row2.Employee_Gender == null) {
									pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3, row2.Employee_Gender);
								}

								if (row2.Employee_Country == null) {
									pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4, row2.Employee_Country);
								}

								if (row2.Employee_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1, row2.Employee_ID);
								}
								...
								if (row2.Employee_ID == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, row2.Employee_ID);
								}

								if (row2.Employee_Job_Title == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, row2.Employee_Job_Title);
								}

								if (row2.Employee_Salary == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tDBOutput_1.setInt(3, row2.Employee_Salary);
								}

								if (row2.Employee_Gender == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(4, row2.Employee_Gender);
								}

								if (row2.Employee_Country == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(5, row2.Employee_Country);
								}
					...
					if (!((Object) (context.folderName
							+ "/files/TablesToDump/Employee.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final dumpEmployee dumpEmployeeClass = new dumpEmployee();

		int exitCode = dumpEmployeeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpEmployee.class.getClassLoader()
					.getResourceAsStream("projetsid/dumpemployee_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpEmployee.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpEmployee");
		}
...
/************************************************************************************************
 * 82987 characters generated by Talend Open Studio for Data Integration on the
 * 8 mai 2024 à 19:15:23 CEST
 ************************************************************************************************/