 ...
 * Description: Remplir la table pays grâces au fichiers csv prédament créer.
 * <br>
 * 
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:e68s+5Ll//4DU51NRdBYhn/UGsHyL3pNeJRibqkGKPU9/vA6Jk6gtrbQjF90mq6jmTue23cD6ni+Gi/+");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Country")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"country\" VARCHAR(50)  ,\"country_Name\" VARCHAR(50)  ,\"country_Id\" VARCHAR(50)  ,primary key(\"country\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"country\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"country\",\"country_Name\",\"country_Id\") VALUES (?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"country_Name\" = ?,\"country_Id\" = ? WHERE \"country\" = ?";
...
///////////////////////		
							...
							if (row1.Country_Name != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Country_Name));
							...
							if (row1.Country_ID != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Country_ID));
...
///////////////////////    			
							...
							if (row2.Country == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.Country);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.Country_Name == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, row2.Country_Name);
								}

								if (row2.Country_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(2, row2.Country_ID);
								}

								if (row2.Country == null) {
									pstmtUpdate_tDBOutput_1.setNull(3 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(3 + count_tDBOutput_1, row2.Country);
								}
								...
								if (row2.Country == null) {
									...
									pstmtInsert_tDBOutput_1.setString(1, row2.Country);
								}

								if (row2.Country_Name == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, row2.Country_Name);
								}

								if (row2.Country_ID == null) {
									pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(3, row2.Country_ID);
								}
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpPays.class.getClassLoader()
					.getResourceAsStream("projetsid/dumppays_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpPays.class.getClassLoader()
...
/************************************************************************************************
 * 75775 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2024 à 15:55:46 CEST
 ************************************************************************************************/