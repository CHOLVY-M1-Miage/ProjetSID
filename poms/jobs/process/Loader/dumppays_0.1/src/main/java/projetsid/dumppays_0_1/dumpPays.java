...
package projetsid.dumppays_0_1;
...
/**
 * Job: dumpPays Purpose: Charger les donnèes dans la table pays.<br>
 * Description: Remplir la table pays grâces au fichiers csv prédament créer. <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class dumpPays implements TalendJob {
...
public String getFolderName(){
	...
	private final String jobName = "dumpPays";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(dumpPays.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:6QIJdDa8thbLjwtbZohP8Hm4KzH/UB540vYIeAj4vBTtVnfMNILrg8vl316bYH2WvZb1ctRMOKhqocXc");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_PROJETSID_dumpPays = new byte[0];
    static byte[] commonByteArray_PROJETSID_dumpPays = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETSID_dumpPays.length) {
				if(length < 1024 && commonByteArray_PROJETSID_dumpPays.length == 0) {
   					commonByteArray_PROJETSID_dumpPays = new byte[1024];
				} else {
   					commonByteArray_PROJETSID_dumpPays = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETSID_dumpPays, 0, length);
			strReturn = new String(commonByteArray_PROJETSID_dumpPays, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJETSID_dumpPays, 0, length);
			strReturn = new String(commonByteArray_PROJETSID_dumpPays, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETSID_dumpPays) {
 ...
 */
    ...
    public static void main(String[] args){
        final dumpPays dumpPaysClass = new dumpPays();

        int exitCode = dumpPaysClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = dumpPays.class.getClassLoader().getResourceAsStream("projetsid/dumppays_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = dumpPays.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dumpPays");
        }
...
/************************************************************************************************
 *     75777 characters generated by Talend Open Studio for Data Integration 
 *     on the 12 avril 2024 à 14:42:20 CEST
 ************************************************************************************************/