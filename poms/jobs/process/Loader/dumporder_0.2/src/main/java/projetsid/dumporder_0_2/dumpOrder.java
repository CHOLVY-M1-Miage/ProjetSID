		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:sEF7UgkTqim8dsAHijxmhXAdDmICTVm8aRjeYRHWjd2USHnKAMFxmIiqIrE4EY53107IFfmi6ILKs6NV");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables(null, null, null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equals(("Customer")) && (schema_tDBOutput_1.equals(dbschema_tDBOutput_1)
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE \"" + tableName_tDBOutput_1
								+ "\"(\"Order_ID\" VARCHAR(20)  ,\"Order_Type\" VARCHAR(20)  ,\"Order_Date\" TIMESTAMP ,\"Delivery_Date\" TIMESTAMP ,\"Country\" VARCHAR(20)  ,\"Total_Retail_Price\" FLOAT4 ,primary key(\"Order_ID\"))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(
						"SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"Order_ID\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"Order_ID\",\"Order_Type\",\"Order_Date\",\"Delivery_Date\",\"Country\",\"Total_Retail_Price\") VALUES (?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"Order_Type\" = ?,\"Order_Date\" = ?,\"Delivery_Date\" = ?,\"Country\" = ?,\"Total_Retail_Price\" = ? WHERE \"Order_ID\" = ?";
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/TablesToDump/Order.csv", "UTF-8", ";", "\n", true, 1, 0,
...
///////////////////////		
							...
							if (row1.Order_Type != null) { //
								...
								strBuffer_tLogRow_1.append(String.valueOf(row1.Order_Type));
							...
							if (row1.Order_Date != null) { //
								...
								strBuffer_tLogRow_1.append(FormatterUtils.format_Date(row1.Order_Date, "dd-MM-yyyy"));
...
///////////////////////    			
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (row2.Order_Type == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, row2.Order_Type);
								}
								...
								if (row2.Country == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(4, row2.Country);
								}

								if (row2.Total_Retail_Price == null) {
									pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.FLOAT);
								} else {
									pstmtUpdate_tDBOutput_1.setFloat(5, row2.Total_Retail_Price);
								}

								if (row2.Order_ID == null) {
									pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1, row2.Order_ID);
								}
								...
								if (row2.Order_Type == null) {
									...
									pstmtInsert_tDBOutput_1.setString(2, row2.Order_Type);
								}
								...
								if (row2.Country == null) {
									...
									pstmtInsert_tDBOutput_1.setString(5, row2.Country);
								}
					...
					if (!((Object) (context.folderName
							+ "/files/TablesToDump/Order.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dumpOrder.class.getClassLoader()
					.getResourceAsStream("projetsid/dumporder_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dumpOrder.class.getClassLoader()
...
/************************************************************************************************
 * 87182 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 18:34:42 CEST
 ************************************************************************************************/