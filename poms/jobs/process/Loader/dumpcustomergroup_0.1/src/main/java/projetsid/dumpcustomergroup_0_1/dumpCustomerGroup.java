		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:AOWVckYIxjdvsZP4WSnQJZmvX8fvTQ7BMAREUxAflfHzsyvF8pdvo3KgMbE9WHFGNjIH093PnBbhD9aG");
...
///////////////////////    			
							...
							if (row2.Customer_Group == null) {
								...
								pstmt_tDBOutput_1.setString(1, row2.Customer_Group);
							}

							if (row2.Customer_Group_ID == null) {
								pstmt_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2 + count_tDBOutput_1, row2.Customer_Group_ID);
							}
...
/************************************************************************************************
 * 75097 characters generated by Talend Open Studio for Data Integration on the
 * 4 mai 2024 à 20:03:49 CEST
 ************************************************************************************************/