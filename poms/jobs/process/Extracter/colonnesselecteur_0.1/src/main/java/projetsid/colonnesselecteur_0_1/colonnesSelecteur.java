 ...
 * Description: Via un script pyhton, extrait d'un CSV uniquement les colonnes
 * utiles. <br>
 * 
	...
	public void tSystem_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final Process ps_tSystem_1 = runtime_tSystem_1.exec("python3 files/casiopExtratColonnes.py",
						env_tSystem_1, new java.io.File(context.folderName));
...
/************************************************************************************************
 * 28004 characters generated by Talend Open Studio for Data Integration on the
 * 7 mai 2024 à 18:00:28 CEST
 ************************************************************************************************/