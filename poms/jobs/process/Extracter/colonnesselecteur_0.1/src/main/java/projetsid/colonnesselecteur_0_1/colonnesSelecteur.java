	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(context.folderName + "/files/BDD_CASIOP.csv"))
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */
						context.folderName + "/files/BDD_CASIOP_FULL.csv"/** End field tFileInputDelimited_1:FILENAME */
				;
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.Order_Item_Num = ParserUtils.parseTo_Integer(
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row2.Customer_Group_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Customer_Group_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Customer_Group != null) {
								sb_tFileOutputDelimited_1.append(row2.Customer_Group);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Customer_Type_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Customer_Type_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Customer_Type != null) {
								sb_tFileOutputDelimited_1.append(row2.Customer_Type);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Birth_Date != null) {
								sb_tFileOutputDelimited_1.append(row2.Birth_Date);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							sb_tFileOutputDelimited_1.append(row2.Gender);
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Customer_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Customer_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							...
							if (row2.Country_Name != null) {
								sb_tFileOutputDelimited_1.append(row2.Country_Name);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Employee_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Employee_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Employee_Job_Title != null) {
								sb_tFileOutputDelimited_1.append(row2.Employee_Job_Title);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Employee_Salary != null) {
								sb_tFileOutputDelimited_1.append(row2.Employee_Salary);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Employee_Gender != null) {
								sb_tFileOutputDelimited_1.append(row2.Employee_Gender);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Employee_Country != null) {
								sb_tFileOutputDelimited_1.append(row2.Employee_Country);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Order_Type != null) {
								sb_tFileOutputDelimited_1.append(row2.Order_Type);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Order_Date != null) {
								sb_tFileOutputDelimited_1.append(row2.Order_Date);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Delivery_Date != null) {
								sb_tFileOutputDelimited_1.append(row2.Delivery_Date);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Product_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Product_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Product_Name != null) {
								sb_tFileOutputDelimited_1.append(row2.Product_Name);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Product_Ref_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Product_Ref_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							sb_tFileOutputDelimited_1.append(row2.Quantity);
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Order_ID != null) {
								sb_tFileOutputDelimited_1.append(row2.Order_ID);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							sb_tFileOutputDelimited_1.append(row2.Order_Item_Num);
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.CostPrice_Per_Unit != null) {
								sb_tFileOutputDelimited_1.append(row2.CostPrice_Per_Unit);
							}
							sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
							if (row2.Total_Retail_Price != null) {
								sb_tFileOutputDelimited_1.append(row2.Total_Retail_Price);
							}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = colonnesSelecteur.class.getClassLoader()
					.getResourceAsStream("projetsid/colonnesselecteur_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = colonnesSelecteur.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : colonnesSelecteur");
		}
...
/************************************************************************************************
 * 124441 characters generated by Talend Open Studio for Data Integration on the
 * 10 mai 2024 à 16:37:26 CEST
 ************************************************************************************************/