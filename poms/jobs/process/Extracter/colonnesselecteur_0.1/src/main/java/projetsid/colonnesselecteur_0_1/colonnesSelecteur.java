 ...
 * Description: Via un script pyhton, extrait d'un CSV uniquement les colonnes utiles. <br>
...
final Process ps_tSystem_1 = runtime_tSystem_1.exec( "python3 files/casiopExtratColonnes.py" ,env_tSystem_1,new java.io.File(context.folderName));
...
/************************************************************************************************
 *     28005 characters generated by Talend Open Studio for Data Integration 
