...
/**
 * Job: main Purpose: Choisi les filtres de transformation<br>
 * Description: Aiguilleur <br>
 * 
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "/home/ethankauy/TOS_DI-20211109_1610-V8.0.1/workspace/in.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"/home/ethankauy/TOS_DI-20211109_1610-V8.0.1/workspace/in.csv", "ISO-8859-15", ";",
					...
					if (!((Object) ("/home/ethankauy/TOS_DI-20211109_1610-V8.0.1/workspace/in.csv") instanceof java.io.InputStream)) {
	...
	public void tFileOutputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(context.folderNames + "/files/BDD_CASIOP.csv"))
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = main.class.getClassLoader()
					.getResourceAsStream("projetsid/main_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 36447 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2024 à 12:04:39 CEST
 ************************************************************************************************/