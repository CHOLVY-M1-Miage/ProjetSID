...
package projetsid.employee_0_1;
...
/**
 * Job: employee Purpose: Table des employes<br>
 * Description: <br>
 * 
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.folderName + "/files/TablesToDump/Employee.csv")).getAbsolutePath().replace("\\", "/");
...
// Start of branch "row5"
						if (row5 != null) {
							...
							row6.Employee_ID = row5.Employee_ID;

							row6.Employee_Job_Title = row5.Employee_Job_Title;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = employee.class.getClassLoader()
					.getResourceAsStream("projetsid/employee_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 109131 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 20:08:38 CEST
 ************************************************************************************************/