		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.folderName + "/files/TablesToDump/Order.csv")).getAbsolutePath().replace("\\", "/");
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row2.Employee_Salary = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row2.Quantity = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if (row2 != null) {
							...
							{ // start of Var scope
								...
								Var.orderDate = TalendDate.parseDate("yyyy/MM/dd",
										row3.Order_Date.split(" ")[5] + "/"
												+ fonctionsPerso.getMonthNumber(row3.Order_Date.split(" ")[1]) + "/"
												+ row3.Order_Date.split(" ")[2]);
								;
								Var.DeliveryDate = TalendDate.parseDate("yyyy/MM/dd",
										row3.Delivery_Date.split(" ")[5] + "/"
												+ fonctionsPerso.getMonthNumber(row3.Delivery_Date.split(" ")[1]) + "/"
												+ row3.Delivery_Date.split(" ")[2]);
								;
...
///////////////////////		
								...
								if (customer.Order_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(customer.Order_ID));

								} //

								strBuffer_tLogRow_1.append("|");

								if (customer.Order_Type != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(customer.Order_Type));

								} //

								strBuffer_tLogRow_1.append("|");

								if (customer.Order_Date != null) { //

									strBuffer_tLogRow_1
											.append(FormatterUtils.format_Date(customer.Order_Date, "dd-MM-yyyy"));

								} //

								strBuffer_tLogRow_1.append("|");

								if (customer.Delivery_Date != null) { //

									strBuffer_tLogRow_1
											.append(FormatterUtils.format_Date(customer.Delivery_Date, "dd-MM-yyyy"));
								...
								if (customer.Country != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(customer.Country));

								} //

								strBuffer_tLogRow_1.append("|");

								if (customer.Total_Retail_Price != null) { //

									strBuffer_tLogRow_1
											.append(FormatterUtils.formatUnwithE(customer.Total_Retail_Price));
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = order.class.getClassLoader()
					.getResourceAsStream("projetsid/order_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = order.class.getClassLoader()
...
/************************************************************************************************
 * 111773 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 18:31:26 CEST
 ************************************************************************************************/