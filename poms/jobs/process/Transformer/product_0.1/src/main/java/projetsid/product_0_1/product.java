...
/**
 * Job: product Purpose: Transformer le produit.csv en produit<br>
 * Description: <br>
 * 
...
public class product implements TalendJob {
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_product = new byte[0];
		static byte[] commonByteArray_PROJETSID_product = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_product.length) {
					if (length < 1024 && commonByteArray_PROJETSID_product.length == 0) {
						commonByteArray_PROJETSID_product = new byte[1024];
					} else {
						commonByteArray_PROJETSID_product = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_product, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_product, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_product, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_product, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_product) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.folderName + "/files/TablesToDump/Product.csv")).getAbsolutePath().replace("\\", "/");
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row2.Product_ID == null) {
								finder_tUniqRow_1.Product_ID = null;
							} else {
								finder_tUniqRow_1.Product_ID = row2.Product_ID.toLowerCase();
							}
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								if (row2.Product_ID == null) {
									new_tUniqRow_1.Product_ID = null;
								} else {
									new_tUniqRow_1.Product_ID = row2.Product_ID.toLowerCase();
								}
								...
								row3.Product_Ref_ID = row2.Product_Ref_ID;
...
///////////////////////		
								...
								if (row3.Product_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row3.Product_ID));
								...
								if (row3.Product_Name != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row3.Product_Name));

								} //

								strBuffer_tLogRow_1.append("|");

								if (row3.Product_Ref_ID != null) { //

									strBuffer_tLogRow_1.append(String.valueOf(row3.Product_Ref_ID));
...
///////////////////////    			
								...
								if (row4.Product_ID != null) {
									sb_tFileOutputDelimited_1.append(row4.Product_ID);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (row4.Product_Name != null) {
									sb_tFileOutputDelimited_1.append(row4.Product_Name);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (row4.Product_Ref_ID != null) {
									sb_tFileOutputDelimited_1.append(row4.Product_Ref_ID);
								}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = product.class.getClassLoader()
					.getResourceAsStream("projetsid/product_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 108902 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2024 à 16:20:48 CEST
 ************************************************************************************************/