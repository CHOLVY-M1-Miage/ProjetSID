...
package projetsid.customer_group_0_1;
...
/**
 * Job: customer_group Purpose: extraire la table pays du csv<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class customer_group implements TalendJob {
	...
	private final String jobName = "customer_group";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					customer_group.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(customer_group.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_PROJETSID_customer_group = new byte[0];
		static byte[] commonByteArray_PROJETSID_customer_group = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.Customer_Group_ID == null) ? 0 : this.Customer_Group_ID.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!this.Customer_Group_ID.equals(other.Customer_Group_ID))
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJETSID_customer_group.length) {
					if (length < 1024 && commonByteArray_PROJETSID_customer_group.length == 0) {
						commonByteArray_PROJETSID_customer_group = new byte[1024];
					} else {
						commonByteArray_PROJETSID_customer_group = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJETSID_customer_group, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_customer_group, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PROJETSID_customer_group, 0, length);
				strReturn = new String(commonByteArray_PROJETSID_customer_group, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJETSID_customer_group) {
		...
		public int compareTo(row4Struct other) {
			...
			returnValue = checkNullsAndCompare(this.Customer_Group_ID, other.Customer_Group_ID);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.folderName + "/files/TablesToDump/Customer_Group.csv")).getAbsolutePath().replace("\\",
								"/");
...
///////////////////////    			
				...
				class KeyStruct_tUniqRow_1 {
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.Customer_Group_ID == null) ? 0 : this.Customer_Group_ID.hashCode());
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = context.folderName + "/files/BDD_CASIOP.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								context.folderName + "/files/BDD_CASIOP.csv", "UTF-8", ";", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.Customer_Group_ID = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.Customer_Group = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.Employee_ID = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 10;

							row1.Employee_Job_Title = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.Employee_Salary = ParserUtils.parseTo_Integer(temp);
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"Employee_Salary", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
							...
							row1.Employee_Gender = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 13;

							row1.Employee_Country = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.Order_Date = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 16;

							row1.Delivery_Date = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.Product_Ref_ID = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							row1.Order_Item_Num = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 23;

							row1.CostPrice_Per_Unit = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 24;

							row1.Total_Retail_Price = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (row2.Customer_Group_ID == null) {
								finder_tUniqRow_1.Customer_Group_ID = null;
							} else {
								finder_tUniqRow_1.Customer_Group_ID = row2.Customer_Group_ID.toLowerCase();
							}
							...
							if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
								...
								if (row2.Customer_Group_ID == null) {
									new_tUniqRow_1.Customer_Group_ID = null;
								} else {
									new_tUniqRow_1.Customer_Group_ID = row2.Customer_Group_ID.toLowerCase();
								}
								...
								row3.Customer_Group = row2.Customer_Group;
...
///////////////////////		
								...
								if (row3.Customer_Group != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row3.Customer_Group));
...
///////////////////////    			
								...
								if (row4.Customer_Group != null) {
									sb_tFileOutputDelimited_1.append(row4.Customer_Group);
								}
					...
					if (!((Object) (context.folderName + "/files/BDD_CASIOP.csv") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final customer_group customer_groupClass = new customer_group();

		int exitCode = customer_groupClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = customer_group.class.getClassLoader()
					.getResourceAsStream("projetsid/customer_group_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = customer_group.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : customer_group");
		}
...
/************************************************************************************************
 * 89219 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 16:38:55 CEST
 ************************************************************************************************/