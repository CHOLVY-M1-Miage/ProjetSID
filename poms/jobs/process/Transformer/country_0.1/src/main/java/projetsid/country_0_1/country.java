...
/**
 * Job: country Purpose: extraire la table pays du csv<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class country implements TalendJob {
...
public String getFolderName(){
	...
	private final String jobName = "country";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(country.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row8Struct implements routines.system.IPersistableRow<row8Struct> {
    final static byte[] commonByteArrayLock_PROJETSID_country = new byte[0];
    static byte[] commonByteArray_PROJETSID_country = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_PROJETSID_country.length) {
				if(length < 1024 && commonByteArray_PROJETSID_country.length == 0) {
   					commonByteArray_PROJETSID_country = new byte[1024];
				} else {
   					commonByteArray_PROJETSID_country = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_PROJETSID_country, 0, length);
			strReturn = new String(commonByteArray_PROJETSID_country, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_PROJETSID_country, 0, length);
			strReturn = new String(commonByteArray_PROJETSID_country, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_PROJETSID_country) {
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.folderName+"/files/TablesToDump/Country.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */context.folderName+"/files/BDD_CASIOP.csv"/** End field tFileInputDelimited_2:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row5.Gender = ParserUtils.parseTo_Character(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
...
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Gender", "row5", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row5.Customer_ID = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row5.Employee_Salary = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Employee_Salary", "row5", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row5.Quantity = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
globalMap.put("tFileInputDelimited_2_ERROR_MESSAGE",ex_tFileInputDelimited_2.getMessage());
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Quantity", "row5", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
...
if(row6.Country == null){
	...
	finder_tUniqRow_1.Country = row6.Country.toLowerCase();
}
if(row6.Country_Name == null){
	finder_tUniqRow_1.Country_Name = null;
}else{
	finder_tUniqRow_1.Country_Name = row6.Country_Name.toLowerCase();
}
...
if(row6.Country == null){
	...
	new_tUniqRow_1.Country = row6.Country.toLowerCase();
}
if(row6.Country_Name == null){
	new_tUniqRow_1.Country_Name = null;
}else{
	new_tUniqRow_1.Country_Name = row6.Country_Name.toLowerCase();
}
if(row6.Country_ID == null){
	...
	row7 = new row7Struct();
}row7.Country = row6.Country;			row7.Country_Name = row6.Country_Name;			row7.Country_ID = row6.Country_ID;					
...
///////////////////////		
				...
				strBuffer_tLogRow_3.append(
				                String.valueOf(row7.Country_Name)							
				);
				...
				strBuffer_tLogRow_3.append(
				                String.valueOf(row7.Country_ID)							
				);
 ...
 */
    ...
    public static void main(String[] args){
        final country countryClass = new country();

        int exitCode = countryClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = country.class.getClassLoader().getResourceAsStream("projetsid/country_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = country.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : country");
        }
...
/************************************************************************************************
 *     104209 characters generated by Talend Open Studio for Data Integration 
