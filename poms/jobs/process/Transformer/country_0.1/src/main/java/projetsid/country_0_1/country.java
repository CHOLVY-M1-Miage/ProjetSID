...
// Start of branch "row7"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = country.class.getClassLoader()
					.getResourceAsStream("projetsid/country_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = country.class.getClassLoader()
...
/************************************************************************************************
 * 99834 characters generated by Talend Open Studio for Data Integration on the
 * 9 mai 2024 à 19:40:42 CEST
 ************************************************************************************************/