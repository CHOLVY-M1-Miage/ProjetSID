...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.folderName+"/files/TablesToDump/Country.csv")).getAbsolutePath().replace("\\","/");
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
                                        ...
                                        row1.Customer_ID = ParserUtils.parseTo_List(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1],String.valueOf(fieldSeparator_tFileInputDelimited_1_ListType[0]));
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Customer_ID", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.Employee_Salary = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"Employee_Salary", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
...
if(row2.Country == null){
	...
	finder_tUniqRow_1.Country = row2.Country.toLowerCase();
}
if(row2.Country_Name == null){
	finder_tUniqRow_1.Country_Name = null;
}else{
	finder_tUniqRow_1.Country_Name = row2.Country_Name.toLowerCase();
}
if(row2.Country_ID == null){
	finder_tUniqRow_1.Country_ID = null;
}else{
	finder_tUniqRow_1.Country_ID = row2.Country_ID.toLowerCase();
}	
...
if(row2.Country == null){
	...
	new_tUniqRow_1.Country = row2.Country.toLowerCase();
}
if(row2.Country_Name == null){
	new_tUniqRow_1.Country_Name = null;
}else{
	new_tUniqRow_1.Country_Name = row2.Country_Name.toLowerCase();
}
if(row2.Country_ID == null){
	new_tUniqRow_1.Country_ID = null;
}else{
	new_tUniqRow_1.Country_ID = row2.Country_ID.toLowerCase();
}
		
		keystUniqRow_1.add(new_tUniqRow_1);if(row3 == null){ 
	
	row3 = new row3Struct();
}row3.Country = row2.Country;			row3.Country_Name = row2.Country_Name;			row3.Country_ID = row2.Country_ID;					
...
///////////////////////		
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.Country_Name)							
				);
				...
				strBuffer_tLogRow_1.append(
				                String.valueOf(row3.Country_ID)							
				);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = pays.class.getClassLoader().getResourceAsStream("projetsid/pays_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
