		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						context.folderName + "/files/TablesToDump/Contry.csv")).getAbsolutePath().replace("\\", "/");
...
///////////////////////		
								...
								if (row3.Country_Name != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row3.Country_Name));
								...
								if (row3.Country_ID != null) { //
									...
									strBuffer_tLogRow_1.append(String.valueOf(row3.Country_ID));
...
///////////////////////    			
								...
								if (row4.Country != null) {
									sb_tFileOutputDelimited_1.append(row4.Country);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (row4.Country_Name != null) {
									sb_tFileOutputDelimited_1.append(row4.Country_Name);
								}
								sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
								if (row4.Country_ID != null) {
									sb_tFileOutputDelimited_1.append(row4.Country_ID);
								}
...
/************************************************************************************************
 * 109505 characters generated by Talend Open Studio for Data Integration on the
 * 12 avril 2024 à 12:23:06 CEST
 ************************************************************************************************/