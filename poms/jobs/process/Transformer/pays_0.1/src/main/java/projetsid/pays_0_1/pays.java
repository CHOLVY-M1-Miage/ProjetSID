...
// Start of branch "row4"
								if (row4 != null) {
									...
									{ // start of Var scope
										...
										Var.dateTalend = TalendDate.parseDate("yyyy/MMM/dd",
												row4.date.split(" ")[5] + "/" + getMonthNumber(row4.date.split(" ")[1])
														+ "/" + row4.date.split(" ")[2]);
										;// ###############################
										// ###############################
										// # Output tables
...
///////////////////////		
										...
										if (date.date != null) { //
											...
											strBuffer_tLogRow_2
													.append(FormatterUtils.format_Date(date.date, "dd-MM-yyyy"));
...
/************************************************************************************************
 * 110254 characters generated by Talend Open Studio for Data Integration on the
 * 7 mai 2024 à 16:27:00 CEST
 ************************************************************************************************/